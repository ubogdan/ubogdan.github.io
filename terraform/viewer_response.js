    ...
    if (headers['content-type'] && headers['content-type'].value == 'text/html') {
        headers['content-security-policy'] = {
            value: "require-trusted-types-for 'script'; default-src 'none'; img-src 'self'; " +
                ...
                "script-src-elem 'self' https://www.googletagmanager.com https://cdn.jsdelivr.net 'sha256-SjP4DKbgzKbSIJ6khH2h4w68+MPNPvsOtujPhgl/Mh4=' 'sha256-4CQqINfLuP3nhL220h322geGof5a8+vo3u5unLM/2rw=' 'sha256-1tqndEcZzFZ8gMUvM8EAVDuiwGkiFpnMg45e2GZGLX8='; " +
